...
COPY --chown=adminer:adminer plugins/tinymce.php /var/www/html/plugins/tinymce.php
...
RUN mkdir -p /var/www/html/plugins-enabled \
    ...
    && echo "<?php require_once('plugins/tinymce.php'); return new AdminerTinymce();" > /var/www/html/plugins-enabled/003-tinymce.php \
